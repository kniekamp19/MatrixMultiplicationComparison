...
This program multiplies two matrices using a conventional iterative matrix multiplication
algorithm (O(n^3)), a recursive algorithm (O(n^3)) and Strassen's matrix multiplication
algorithm (O(n^lg7)).
